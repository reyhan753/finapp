...
public class adp_income extends RecyclerView.Adapter<adp_income.ViewHolder> {
    ArrayList<cs_income> list;
    Context ctx;

    public adp_income(@NonNull ArrayList<cs_income> list, Context ctx) {
        this.list = list;
        this.ctx = ctx;
    }
    ...
    {
        cs_income item=list.get(position);
